...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 16, 2025 at 01:12 PM
...
INSERT INTO `books` (`book_id`, `isbn`, `title`, `author`, `publisher`, `publication_year`, `genre`, `total_copies`) VALUES
(3, NULL, 'Murder Of Crows', 'Amielle Brieta', '', '2025', 'Horror, Law, Crime', 12),
(5, '', 'a', 'a', '', '2025', 'a', 1),
(8, '', 'b', 'b', '', '2025', '', 1),
(9, '', 'b', 'b', '', '2025', '', 1);
...
(8, 4, 'Banned', 'Banned@banned.com', '$2y$10$h6xR6UCwCBJ3fFnjxuVh7O1RR7Rht45q3Nox/02W9dzT6xTAmS6Pi', NULL, NULL, NULL, NULL, '2025-11-16 12:09:12');
...
ALTER TABLE `loans`
  ...
  ADD KEY `fk_returned_by_user` (`returned_by_user_id`);
...
ALTER TABLE `loans`
  ...
  ADD CONSTRAINT `fk_loan_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_returned_by_user` FOREIGN KEY (`returned_by_user_id`) REFERENCES `users` (`user_id`) ON DELETE SET NULL ON UPDATE CASCADE;
